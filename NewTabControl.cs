...
namespace SportMusic
{
    ...
    public class NewTabPanel : System.Windows.Forms.Panel                                //Новый контрол
    {
        ...
        private void Sort()
        {
            ...
            {
                panel.BackgroundImage = SportMusic.Properties.Resources.tab_c_74;  //Задаем фоном, что вкладка не активна
                panel.Top = i;
                i += panel.Height;
            }

            if (tabControl.SelectedTab != null && this.ListTabButton.ContainsKey(tabControl.SelectedTab))
                ((PanelTP)this.ListTabButton[tabControl.SelectedTab]).BackgroundImage = SportMusic.Properties.Resources.tab_c_73; //Красим выделенную вкладку
        }
    ...
    public class PanelTP : System.Windows.Forms.Panel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Height = 27;
            this.Width = 128;
            this.BackgroundImage = SportMusic.Properties.Resources.tab_c_74;
            ...
            Icon.Left = 3;
            Icon.Top = 5;
            Icon.Image = SportMusic.Properties.Resources.green_dialbut_611;
